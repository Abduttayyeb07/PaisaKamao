...
const BUY_ZIG_ZONES: TradeZone[] = [
  { min: 1.0265, max: 1.0270, sizeZig: 1501,  label: 'BUY_ZIG 1.0265-1.0270', orderId: 'O1' },
  { min: 1.0270, max: 1.0275, sizeZig: 5002,  label: 'BUY_ZIG 1.0270-1.0275', orderId: 'O2' },
  { min: 1.0275, max: 1.0290, sizeZig: 10003, label: 'BUY_ZIG 1.0275-1.0290', orderId: 'O3' },
  { min: 1.0290, max: 1.0300, sizeZig: 15004, label: 'BUY_ZIG 1.0290-1.0300', orderId: 'P' },
  { min: 1.0300, max: 1.0310, sizeZig: 15005, label: 'BUY_ZIG 1.0300-1.0310', orderId: 'Q' },
  { min: 1.0315, max: 1.0325, sizeZig: 25006, label: 'BUY_ZIG 1.0315-1.0325', orderId: 'R' },
  { min: 1.0325, max: 1.0330, sizeZig: 25007, label: 'BUY_ZIG 1.0325-1.0330', orderId: 'S' },
  { min: 1.0330, max: 1.0340, sizeZig: 25008, label: 'BUY_ZIG 1.0330-1.0340', orderId: 'T' },
  { min: 1.0340, max: 1.0350, sizeZig: 25009, label: 'BUY_ZIG 1.0340-1.0350', orderId: 'U' },
  { min: 1.0350, max: 1.0360, sizeZig: 30010, label: 'BUY_ZIG 1.0350-1.0360', orderId: 'V' },
  { min: 1.0360, max: 1.0370, sizeZig: 30011, label: 'BUY_ZIG 1.0360-1.0370', orderId: 'X1' },
  { min: 1.0370, max: 1.0380, sizeZig: 50012, label: 'BUY_ZIG 1.0370-1.0380', orderId: 'X2' },
  { min: 1.0400, max: 1.0600, sizeZig: 80013, label: 'BUY_ZIG 1.0400-1.0600', orderId: 'X3' },
  { min: 1.0600, max: 1.1000, sizeZig: 90014, label: 'BUY_ZIG 1.0600-1.1000', orderId: 'X4' },
  { min: 1.0900, max: 1.2000, sizeZig: 99015, label: 'BUY_ZIG 1.0900-1.2000', orderId: 'X5' },
];



const BUY_STZIG_ZONES: TradeZone[] = [
  { min: 1.0250, max: 1.0255, sizeZig: 2501,  label: 'BUY_STZIG 1.0250-1.0255', orderId: 'N9a' },
  { min: 1.0245, max: 1.0250, sizeZig: 5002,  label: 'BUY_STZIG 1.0245-1.0250', orderId: 'N9b' },
  { min: 1.0220, max: 1.0245, sizeZig: 8003,  label: 'BUY_STZIG 1.0220-1.0245', orderId: 'N8' },
  { min: 1.0235, max: 1.0240, sizeZig: 10104, label: 'BUY_STZIG 1.0235-1.0240', orderId: 'N7' },
  { min: 1.0230, max: 1.0235, sizeZig: 12005, label: 'BUY_STZIG 1.0230-1.0235', orderId: 'N6' },
  { min: 1.0220, max: 1.0230, sizeZig: 15106, label: 'BUY_STZIG 1.0220-1.0230', orderId: 'N5' },
  { min: 1.0210, max: 1.0220, sizeZig: 15007, label: 'BUY_STZIG 1.0210-1.0220', orderId: 'N4' },
  { min: 1.0200, max: 1.0210, sizeZig: 15008, label: 'BUY_STZIG 1.0200-1.0210', orderId: 'N3' },
  { min: 1.0190, max: 1.0200, sizeZig: 20009, label: 'BUY_STZIG 1.0190-1.0200', orderId: 'N2' },
  { min: 1.0180, max: 1.0190, sizeZig: 30000, label: 'BUY_STZIG 1.0180-1.0190', orderId: 'N1' },
  { min: 1.0170, max: 1.0180, sizeZig: 30010, label: 'BUY_STZIG 1.0170-1.0180', orderId: 'A' },
  { min: 1.0160, max: 1.0170, sizeZig: 50011, label: 'BUY_STZIG 1.0160-1.0170', orderId: 'B' },
  { min: 1.0115, max: 1.0160, sizeZig: 60012, label: 'BUY_STZIG 1.0115-1.0160', orderId: 'C' },
  { min: 1.0101, max: 1.0110, sizeZig: 70013, label: 'BUY_STZIG 1.0101-1.0110', orderId: 'D' },
  { min: 1.0090, max: 1.0100, sizeZig: 75014, label: 'BUY_STZIG 1.0090-1.0100', orderId: 'E' },
  { min: 1.0070, max: 1.0080, sizeZig: 80015, label: 'BUY_STZIG 1.0070-1.0080', orderId: 'F' },
  { min: 1.0060, max: 1.0070, sizeZig: 85021, label: 'BUY_STZIG 1.0060-1.0070', orderId: 'G' },
  { min: 1.0050, max: 1.0060, sizeZig: 90022, label: 'BUY_STZIG 1.0050-1.0060', orderId: 'H' },
  { min: 1.0040, max: 1.0050, sizeZig: 95023, label: 'BUY_STZIG 1.0040-1.0050', orderId: 'I' },
  { min: 1.0030, max: 1.0040, sizeZig: 99024, label: 'BUY_STZIG 1.0030-1.0040', orderId: 'J' },
  { min: 1.0020, max: 1.0030, sizeZig: 99025, label: 'BUY_STZIG 1.0020-1.0030', orderId: 'K' },
  { min: 1.0010, max: 1.0020, sizeZig: 99026, label: 'BUY_STZIG 1.0010-1.0020', orderId: 'L' },
  { min: 1.0000, max: 1.0010, sizeZig: 42027, label: 'BUY_STZIG 1.0000-1.0010', orderId: 'M' },
  { min: 0.9000, max: 0.9990, sizeZig: 45000, label: 'BUY_STZIG 0.9000-0.9990', orderId: 'N' },
  { min: 0.8100, max: 0.9900, sizeZig: 50000, label: 'BUY_STZIG 0.8100-0.9900', orderId: 'O' },
  { min: 0.8100, max: 0.9400, sizeZig: 100000, label: 'BUY_STZIG 0.8100-0.9400', orderId: 'P' },
];
