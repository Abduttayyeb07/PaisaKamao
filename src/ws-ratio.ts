...
const BUY_ZIG_ZONES: TradeZone[] = [
  ...
  { min: 1.022, max: 1.0229, sizeZig: 30000, label: 'BUY_ZIG 1.0220-1.0229', orderId: 'U' },
  { min: 1.023, max: 1.0239, sizeZig: 30000, label: 'BUY_ZIG 1.0230-1.0239', orderId: 'V' },
  { min: 1.024, max: 1.0250, sizeZig: 50000, label: 'BUY_ZIG 1.0240-1.0250', orderId: 'X' },
];
...
const BUY_STZIG_ZONES: TradeZone[] = [
  ...
  { min: 1.0090, max: 1.0100, sizeZig: 15000, label: 'BUY_STZIG 1.0090-1.0100', orderId: 'C' },
  { min: 1.0070, max: 1.0080, sizeZig: 25000, label: 'BUY_STZIG 1.0070-1.0080', orderId: 'D' },
  { min: 1.0060, max: 1.0070, sizeZig: 25000, label: 'BUY_STZIG 1.0060-1.0070', orderId: 'E' },
  { min: 1.0050, max: 1.0060, sizeZig: 25000, label: 'BUY_STZIG 1.0050-1.0060', orderId: 'F' },
  { min: 1.0040, max: 1.0050, sizeZig: 25000, label: 'BUY_STZIG 1.0040-1.0050', orderId: 'G' },
  { min: 1.0030, max: 1.0040, sizeZig: 30000, label: 'BUY_STZIG 1.0030-1.0040', orderId: 'H' },
  { min: 1.0020, max: 1.0030, sizeZig: 30000, label: 'BUY_STZIG 1.0020-1.0030', orderId: 'I' },
  { min: 1.0010, max: 1.0020, sizeZig: 30000, label: 'BUY_STZIG 1.0010-1.0020', orderId: 'J' },
