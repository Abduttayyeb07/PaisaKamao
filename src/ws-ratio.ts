...
const BUY_ZIG_ZONES: TradeZone[] = [
  { min: 1.038, max: 1.0385, sizeZig: 1, label: 'BUY_ZIG 1.024-1.0245', orderId: 'O1' },
  { min: 1.0385, max: 1.039, sizeZig: 2, label: 'BUY_ZIG 1.0245-1.025', orderId: 'O1' },
  { min: 1.039, max: 1.040, sizeZig: 3, label: 'BUY_ZIG 1.025-1.026', orderId: 'O2' },
  { min: 1.040, max: 1.041, sizeZig: 4, label: 'BUY_ZIG 1.026-1.027', orderId: 'O3' },
  { min: 1.041, max: 1.042, sizeZig: 5, label: 'BUY_ZIG 1.027-1.028', orderId: 'P' },
  { min: 1.042, max: 1.043, sizeZig: 6, label: 'BUY_ZIG 1.028-1.029', orderId: 'Q' },
  { min: 1.043, max: 1.044, sizeZig: 7, label: 'BUY_ZIG 1.030-1.031', orderId: 'S' },
  { min: 1.044, max: 1.045, sizeZig: 8, label: 'BUY_ZIG 1.031-1.032', orderId: 'T' },
  { min: 1.045, max: 1.046, sizeZig: 9, label: 'BUY_ZIG 1.032-1.033', orderId: 'U' },
  { min: 1.046, max: 1.047, sizeZig: 10, label: 'BUY_ZIG 1.033-1.034', orderId: 'V' },
  { min: 1.047, max: 1.048, sizeZig: 11, label: 'BUY_ZIG 1.034-1.040', orderId: 'X1' },
  { min: 1.048, max: 1.07, sizeZig: 12, label: 'BUY_ZIG 1.040-1.06', orderId: 'X2' },
  { min: 1.070, max: 1.1, sizeZig: 13, label: 'BUY_ZIG 1.06-1.1', orderId: 'X3' },
  { min: 1.1, max: 1.2, sizeZig: 14, label: 'BUY_ZIG 1.09-1.2', orderId: 'X4' },
];


const BUY_STZIG_ZONES: TradeZone[] = [
  { min: 1.035, max: 1.0355, sizeZig: 1, label: 'BUY_STZIG 1.0235-1.024', orderId: 'N9' },
  { min: 1.0344, max: 1.035, sizeZig: 2, label: 'BUY_STZIG 1.023-1.0235', orderId: 'N9' },
  { min: 1.0342, max: 1.0344, sizeZig: 3, label: 'BUY_STZIG 1.022-1.023', orderId: 'N9' },
  { min: 1.034, max: 1.0342, sizeZig: 4, label: 'BUY_STZIG 1.021-1.022', orderId: 'N8' },
  { min: 1.033, max: 1.034, sizeZig: 5, label: 'BUY_STZIG 1.020-1.021', orderId: 'N7' },
  { min: 1.032, max: 1.033, sizeZig: 1, label: 'BUY_STZIG 1.018-1.019', orderId: 'N5' },
  { min: 1.031, max: 1.032, sizeZig: 1, label: 'BUY_STZIG 1.017-1.018', orderId: 'N4' },
  { min: 1.030, max: 1.031, sizeZig: 2, label: 'BUY_STZIG 1.016-1.017', orderId: 'N3' },
  { min: 1.028, max: 1.030, sizeZig: 3, label: 'BUY_STZIG 1.015-1.016', orderId: 'N2' },
  { min: 1.026, max: 1.028, sizeZig: 3, label: 'BUY_STZIG 1.014-1.015', orderId: 'N1' },
  { min: 1.024, max: 1.026, sizeZig: 5, label: 'BUY_STZIG 1.013-1.014', orderId: 'N' },
  { min: 1.020, max: 1.024, sizeZig: 6, label: 'BUY_STZIG 1.0116-1.0120', orderId: 'A' },
  { min: 1.0101, max: 1.020, sizeZig: 7, label: 'BUY_STZIG 1.0101-1.0110', orderId: 'B' },
  { min: 1.009, max: 1.01, sizeZig: 7, label: 'BUY_STZIG 1.0090-1.0100', orderId: 'C' },
  { min: 1.007, max: 1.008, sizeZig: 8, label: 'BUY_STZIG 1.0070-1.0080', orderId: 'D' },
  { min: 1.006, max: 1.007, sizeZig: 8, label: 'BUY_STZIG 1.0060-1.0070', orderId: 'E' },
  { min: 1.005, max: 1.006, sizeZig: 9, label: 'BUY_STZIG 1.0050-1.0060', orderId: 'F' },
  { min: 1.004, max: 1.005, sizeZig: 9, label: 'BUY_STZIG 1.0040-1.0050', orderId: 'G' },
  { min: 1.003, max: 1.004, sizeZig: 9, label: 'BUY_STZIG 1.0030-1.0040', orderId: 'H' },
  { min: 1.002, max: 1.003, sizeZig: 9, label: 'BUY_STZIG 1.0020-1.0030', orderId: 'I' },
  { min: 1.001, max: 1.002, sizeZig: 9, label: 'BUY_STZIG 1.0010-1.0020', orderId: 'J' },
  { min: 1.0, max: 1.001, sizeZig: 4, label: 'BUY_STZIG 1.0000-1.0010', orderId: 'K' },
  { min: 0.90, max: 0.999, sizeZig: 4, label: 'BUY_STZIG 0.9900-0.9990', orderId: 'L' },
  { min: 0.81, max: 0.99, sizeZig: 5, label: 'BUY_STZIG 0.9800-0.9900', orderId: 'M' },
  { min: 0.81, max: 0.94, sizeZig: 10, label: 'BUY_STZIG 0.9800-0.9900', orderId: 'M2' },
];
const EPSILON = 1e-9;
