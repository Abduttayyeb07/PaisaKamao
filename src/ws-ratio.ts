...
const BUY_ZIG_ZONES: TradeZone[] = [
  { min: 1.0395, max: 1.04, sizeZig: 1501, label: 'BUY_ZIG 1.024-1.0245', orderId: 'O1' },
  { min: 1.040, max: 1.041, sizeZig: 5002, label: 'BUY_ZIG 1.0245-1.025', orderId: 'O2' },
  { min: 1.041, max: 1.042, sizeZig: 10005, label: 'BUY_ZIG 1.027-1.028', orderId: 'P' },
  { min: 1.042, max: 1.043, sizeZig: 15006, label: 'BUY_ZIG 1.028-1.029', orderId: 'Q' },
  { min: 1.043, max: 1.044, sizeZig: 15008, label: 'BUY_ZIG 1.030-1.031', orderId: 'S' },
  { min: 1.044, max: 1.045, sizeZig: 15009, label: 'BUY_ZIG 1.031-1.032', orderId: 'T' },
  { min: 1.045, max: 1.046, sizeZig: 30010, label: 'BUY_ZIG 1.032-1.033', orderId: 'U' },
  { min: 1.046, max: 1.048, sizeZig: 30011, label: 'BUY_ZIG 1.033-1.034', orderId: 'V' },
  { min: 1.048, max: 1.049, sizeZig: 50012, label: 'BUY_ZIG 1.034-1.040', orderId: 'X1' },
  { min: 1.049, max: 1.07, sizeZig: 80013, label: 'BUY_ZIG 1.040-1.06', orderId: 'X2' },
...
const BUY_STZIG_ZONES: TradeZone[] = [
 { min: 1.036, max: 1.0375, sizeZig: 2501, label: 'BUY_STZIG 1.0235-1.024', orderId: 'N9' },
 { min: 1.0346, max: 1.036, sizeZig: 5002, label: 'BUY_STZIG 1.023-1.0235', orderId: 'N91' },
 { min: 1.0342, max: 1.0344, sizeZig: 8003, label: 'BUY_STZIG 1.022-1.023', orderId: 'N92' },
 ...
 { min: 1.032, max: 1.033, sizeZig: 15007, label: 'BUY_STZIG 1.018-1.019', orderId: 'N5' },
 { min: 1.031, max: 1.032, sizeZig: 15008, label: 'BUY_STZIG 1.017-1.018', orderId: 'N4' },
 { min: 1.030, max: 1.031, sizeZig: 20009, label: 'BUY_STZIG 1.016-1.017', orderId: 'N3' },
 { min: 1.028, max: 1.030, sizeZig: 30000, label: 'BUY_STZIG 1.015-1.016', orderId: 'N2' },
 { min: 1.026, max: 1.028, sizeZig: 30010, label: 'BUY_STZIG 1.014-1.015', orderId: 'N1' }, 
 { min: 1.024, max: 1.026, sizeZig: 50011, label: 'BUY_STZIG 1.013-1.0140', orderId: 'N' },
  { min: 1.020, max: 1.024, sizeZig: 60012, label: 'BUY_STZIG 1.0116-1.0120', orderId: 'A' },
  { min: 1.0101, max: 1.020, sizeZig: 70013, label: 'BUY_STZIG 1.0101-1.0110', orderId: 'B' },
  { min: 1.009, max: 1.01, sizeZig: 75014, label: 'BUY_STZIG 1.0090-1.0100', orderId: 'C' },
  { min: 1.007, max: 1.008, sizeZig: 80015, label: 'BUY_STZIG 1.0070-1.0080', orderId: 'D' },
  { min: 1.006, max: 1.007, sizeZig: 85021, label: 'BUY_STZIG 1.0060-1.0070', orderId: 'E' },
  { min: 1.005, max: 1.006, sizeZig: 90022, label: 'BUY_STZIG 1.0050-1.0060', orderId: 'F' },
  { min: 1.004, max: 1.005, sizeZig: 95023, label: 'BUY_STZIG 1.0040-1.0050', orderId: 'G' },
  { min: 1.003, max: 1.004, sizeZig: 99024, label: 'BUY_STZIG 1.0030-1.0040', orderId: 'H' },
  { min: 1.002, max: 1.003, sizeZig: 99025, label: 'BUY_STZIG 1.0020-1.0030', orderId: 'I' },
  { min: 1.001, max: 1.002, sizeZig: 99026, label: 'BUY_STZIG 1.0010-1.0020', orderId: 'J' },
  { min: 1.0, max: 1.001, sizeZig: 42027, label: 'BUY_STZIG 1.0000-1.0010', orderId: 'K' },
  { min: 0.90, max: 0.999, sizeZig: 45000, label: 'BUY_STZIG 0.9900-0.9990', orderId: 'L' },
  { min: 0.81, max: 0.99, sizeZig: 50000, label: 'BUY_STZIG 0.9800-0.9900', orderId: 'M' },
  { min: 0.81, max: 0.94, sizeZig: 100000, label: 'BUY_STZIG 0.9800-0.9900', orderId: 'M2' },
];
