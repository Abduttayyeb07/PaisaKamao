...
  { min: 1.043, max: 1.044, sizeZig: 25008, label: 'BUY_ZIG 1.030-1.031', orderId: 'S' },
  { min: 1.044, max: 1.045, sizeZig: 25009, label: 'BUY_ZIG 1.031-1.032', orderId: 'T' },
  { min: 1.045, max: 1.046, sizeZig: 30010, label: 'BUY_ZIG 1.032-1.033', orderId: 'U' },
  { min: 1.046, max: 1.047, sizeZig: 30011, label: 'BUY_ZIG 1.033-1.034', orderId: 'V' },
  { min: 1.047, max: 1.048, sizeZig: 50012, label: 'BUY_ZIG 1.034-1.040', orderId: 'X1' },
  { min: 1.048, max: 1.07, sizeZig: 80013, label: 'BUY_ZIG 1.040-1.06', orderId: 'X2' },
...
 { min: 1.024, max: 1.026, sizeZig: 50011, label: 'BUY_STZIG 1.013-1.014', orderId: 'N' },
